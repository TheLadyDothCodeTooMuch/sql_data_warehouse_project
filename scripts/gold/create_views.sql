...
-- Description: 
--     Creates the sales fact table in the gold layer by integrating
--     cleaned sales data from the silver layer with dimension tables 
--     for products and customers.
-- 
-- Key Notes:
--   • Links transactional sales data to product and customer dim tables.
--   • Provides a clean, analysis-ready structure for BI/reporting.
--   • Uses LEFT JOINs to preserve all sales even if dimension records are missing.
-- ================================================================

CREATE VIEW gold.fact_sales AS
SELECT
    sd.sls_ord_num AS order_number,
    pr.id AS product_key, -- Foreign key linking to product dimension table
    cu.customer_key, -- Foreign key linking to customer dimension table
